...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 bg-[#0a2540] shadow-lg">
      {/* Top bar: subtitle left, desktop nav right */}
      <div className=" text-white max-w-7xl mx-auto">
        <div className="container mx-auto px-4 py-2 flex items-center justify-between">
          <p className="text-xs text-gray-300">Marketplace Vendor - Distribusi koperasi Indonesia</p>
        ...
        <div className="bg-[#0a2540] border-t border-gray-700">
