    ...
    return (
        <div className="p-6">
            <div className="mb-8">
                ...
                <p className="text-slate-500 mt-1">Cari vendor dan ajukan permintaan afiliasi untuk bekerjasama.</p>
            </div>

            {/* Search Section */}
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 mb-8 max-w-6xl mx-auto">
                ...
                {users.length > 0 ? (
                    ...
                    hasSearched && !isLoading && (
                        <div className="col-span-full text-center py-12 text-slate-400">
                            ...
                            <p>Tidak ditemukan vendor dengan kata kunci tersebut.</p>
                        </div>
                    )
                )}
            </div>
