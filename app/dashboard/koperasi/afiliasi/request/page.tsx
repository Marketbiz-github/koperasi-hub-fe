...
export default function RequestAffiliationPage() {
    ...
    const fetchItems = useCallback(async (search: string = '') => {
        ...
        try {
                ...
                for (const user of usersList) {
                    try {
                        ...
                        if (storeData) {
                            ...
                            // Even if no store data, we keep the user but store is null
                            newItemsArray.push({
                                ...user,
                                store: null
                            });
            ...
            console.error(error);
            setMessage({ type: 'error', text: 'Gagal mencari vendor' });
        } finally {
            setIsLoading(false);
    ...
    return (
        <div className="p-6">
            <div className="mb-8">
                <h1 className="text-2xl font-bold text-slate-900">Request Afiliasi ke Vendor</h1>
                <p className="text-slate-500 mt-1">Cari vendor melalui nama toko dan ajukan permintaan afiliasi.</p>
            </div>
                ...
                <form onSubmit={handleSearch} className="flex gap-4">
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            placeholder="Cari nama toko vendor..."
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-slate-50 border-b border-slate-200 text-slate-600 text-[10px] font-bold uppercase tracking-wider">
                                ...
                                <th className="px-6 py-4">Toko Vendor</th>
                                    ...
                                    <td colSpan={5} className="px-6 py-12 text-center text-slate-400">
                                        {isLoading ? (
                                            ...
                                            <div className="flex flex-col items-center gap-2">
                                                ...
                                                <p>{hasSearched ? 'Tidak ditemukan vendor dengan kriteria tersebut.' : 'Gunakan kolom pencarian untuk menemukan vendor.'}</p>
                                            </div>
                                        )}
                                    </td>
                                </tr>
