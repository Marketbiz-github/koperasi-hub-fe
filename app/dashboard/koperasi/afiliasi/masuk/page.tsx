...
export default function IncomingAffiliationsPage() {
    ...
    const fetchAffiliations = useCallback(async () => {
        ...
        setIsLoading(true);
        try {
            const response = await affiliationService.getIncoming(token, { types: ['reseller_koperasi'] });
            if (response.data) {
        ...
        <div className="p-6">
            <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 mt-1">Kelola permintaan afiliasi dari Reseller yang ingin bergabung.</p>
                </div>
