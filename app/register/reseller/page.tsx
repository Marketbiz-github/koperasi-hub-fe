...
function RegisterResellerContent() {
    ...
    const validateForm = (): boolean => {
        ...
        if (!formData.minishop_name.trim()) {
            newErrors.minishop_name = 'Nama reseller harus diisi';
        }
    ...
    async function handleRegister(e: React.FormEvent) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setSuccessMessage('Registrasi Reseller berhasil! Silakan cek email Anda untuk aktivasi akun.');
                setTimeout(() => {
                    router.push('/login');
                }, 3000);
            } else {
        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-4 font-sans py-12">
            <div className="w-full max-w-2xl">
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-8 md:p-10">
                    <div className="mb-10">
                        <h2 className="text-2xl font-bold text-slate-900">Daftar Sebagai Reseller</h2>
                        <p className="text-slate-500 mt-1">Mulai bisnis Anda sendiri dengan modal minimal.</p>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-8">
                        ...
                        <div className="space-y-5 pt-4">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <h3 className="text-lg font-bold text-slate-800">Detail Bisnis</h3>
                            </div>

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div className="md:col-span-2">
                                    <label htmlFor="minishop_name" className="block text-sm font-semibold text-slate-700 mb-2">
                                        Nama Toko / Reseller <span className="text-red-500">*</span>
                                    </label>
                                    <input
                                        id="minishop_name"
                                        name="minishop_name"
                        ...
                        >
                            ...
                            {isLoading ? 'Memproses Registrasi...' : 'Daftar Sebagai Reseller'}
                        </button>
                    </form>
